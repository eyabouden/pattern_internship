#!/usr/bin/env python3
"""
Test script to verify GraphRAG is using the existing knowledge graph
"""

import requests
import json

def test_graphrag_with_knowledge_graph():
    """Test that GraphRAG uses the existing knowledge graph correctly"""
    ...
    print("\n🧠 Testing GraphRAG analysis with existing knowledge graph...")
    ...
    payload = {
        ...
        "data": []  # Empty data - should use existing knowledge graph
    }
    
    try:
        print(f"Query: {test_query}")
        print("Sending request to GraphRAG analyzer...")
...
if __name__ == "__main__":
    test_graphrag_with_knowledge_graph()
